...
class Repository(ABC):
    ...
    # Words that carry no discriminating signal in this catalog (every item is a
    # women's casual dress) or are conversational filler. Dropping them means a
    # query like "can you show me the price of the jessica simpson midi dress"
    # is matched on the words that matter (jessica, simpson, midi).
    _STOPWORDS = {
        "dress", "dresses", "casual", "women", "womens", "woman", "ladies",
        "show", "me", "find", "get", "the", "a", "an", "can", "could", "let",
        "know", "please", "price", "cost", "do", "you", "have", "in", "of",
        "for", "want", "looking", "look", "need", "i", "my", "is", "it", "this",
        "that", "like", "one", "any", "some", "with", "and", "or", "to", "on",
        "under", "below", "less", "than", "whats", "what", "tell", "about",
    }
